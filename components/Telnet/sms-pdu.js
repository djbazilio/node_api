...
(function(){
    ...
    var tokens = {
        ...
        ToA: function( octet ) {
            ...
            if (ToN === 0) {
                ...
                text += 'Alphanumeric, (coded according to GMS TS 03.38 7-bit default alphabet)';
            }
            else if (ToN === 0x60) {
    ...
    /**
     * Decodes septets-in-octets encoding of the GMS 7 Bit character set
     *
     * @param {Array} octets
    ...
    /**
     * GMS 7 bit default alphabet lookup table
     *
